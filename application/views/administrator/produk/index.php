                ...
                <div class="forms">
                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                        <div class="form-title">
                            <button onclick="tambah_produk()" style="width: 250px; " class="btn btn-lg btn-primary btn-block">+ Tambah Data Produk</button>
                        </div>
                            ...
                            <div class="form-three widget-shadow">
                                <div>
                                    ...
                                    <div class="form-group has-success has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="kode_produk" id="kode_produk" aria-describedby="inputSuccess2Status">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group has-success has-feedback">
                                        <label class="control-label" for="inputSuccess2">Satuan</label>
                                        <input type="text" class="form-control" name="satuan" id="satuan" aria-describedby="inputSuccess2Status">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group has-success has-feedback">
                                    ...
                                    <div class="form-group has-success has-feedback">
                                        ...
                                        <input type="number" class="form-control" name="harga_beli" id="harga_beli" aria-describedby="inputSuccess2Status">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group has-success has-feedback">
                                        <label class="control-label" for="inputSuccess2">Harga Jual Umum</label>
                                        <input type="number" class="form-control" name="harga_umum" id="harga_umum" aria-describedby="inputSuccess2Status">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group has-success has-feedback">
                                        <label class="control-label" for="inputSuccess2">Harga Jual Langganan</label>
                                        <input type="number" class="form-control" name="harga_langganan" id="harga_langganan" aria-describedby="inputSuccess2Status">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('administrator/produk/data_produk') ?>",
                    "type": "POST"
                },
        ...
        function save() {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('administrator/produk/tambah') ?>"
            } else {
                url = "<?php echo site_url('administrator/produk/update') ?>"
            }
        ...
        function edit_produk(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('administrator/produk/edit') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
        ...
        function hapus_produk(id) {
            if (confirm('Apakah Anda yakin menghapus data?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('administrator/produk/hapus') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
