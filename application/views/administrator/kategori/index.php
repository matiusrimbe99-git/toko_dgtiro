    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('administrator/kategori/data_kategori') ?>",
                    "type": "POST"
                },
        ...
        function save() {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('administrator/kategori/tambah') ?>"
            } else {
                url = "<?php echo site_url('administrator/kategori/update') ?>"
            }
        ...
        function edit_kategori(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('administrator/kategori/edit/') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
        ...
        function hapus_kategori(id) {
            if (confirm('Apakah Anda yakin menghapus data?')) {
                ...
                $.ajax({
                    url: "<?php echo site_url('administrator/kategori/hapus') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
