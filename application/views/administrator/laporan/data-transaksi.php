            ...
            <div style="background-color: #fffdf8;" class="card-body">
                <table style="height: 60px;">
                    <tr>
                        ...
                        <td style="width: 25%;"></td>
                        <td style="width: 25%;"></td>
                        <form action="<?php echo site_url('administrator/data_transaksi'); ?>" method="get">
                    ...
                    <form action="">
                        <tr>
                            ...
                            <td style="width: 25%;">
                                ...
                                <a href="<?php echo site_url('administrator/data_transaksi') ?>" class="btn btn-danger left"><i class="fa fa-times"></i> Reset</a>
                            </td>
                        </tr>
                    </form>
                </table>
