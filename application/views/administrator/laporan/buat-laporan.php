                        ...
                        <tr>
                            ...
                            <td style="width: 25%;">
                                ...
                                <?php if ($this->input->get('from') != '') : ?>
                                    <a title="Cetak" href="<?php echo base_url("administrator/data_transaksi/cetaklaporan?from={$this->input->get('from')}&to={$this->input->get('to')}&kasir={$this->input->get('kasir')}") ?>" class="btn btn-success top" target="_blank"><i class="fa fa-print"></i></a>
                                <?php endif; ?>
                                <a title="Reset" href="<?php echo site_url('administrator/data_transaksi/report') ?>" class="btn btn-danger left"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    </form>
                </table>
...
<script>
    $(document).ready(function(argument) {
        ...
        $('button.delete-transaksi').on('click', function() {
            var ID = $(this).data('id');
            window.location.href = "<?php echo site_url('administrator/data_transaksi/delete_transaksi/') ?>" + ID;
        });
