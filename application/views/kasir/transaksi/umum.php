                                ...
                                <tr>
                                    <td style="width: 60%; ">
                                        <div style="text-align: center;">
                                            ...
                                            <a href="<?php echo site_url('kasir/transaksi_umum/cancel_transaction') ?>" class="btn btn-danger"><i class="fa fa-times"></i> Batalkan</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('kasir/transaksi_umum/data_transaksi') ?>",
                "type": "POST"
            },
        })
        ...
        $('#table_produk').DataTable({
            ...
            "ordering": false,
            "ajax": {
                "url": "<?php echo site_url('kasir/transaksi_umum/data_produk') ?>",
                "type": "POST"
            },
        })
    ...
    $.ajax({
        url: "<?php echo site_url('kasir/transaksi_umum/get_total/') ?>",
        type: "GET",
        dataType: "JSON",
    ...
    function masukkan() {
        ...
        $.ajax({
            url: "<?php echo site_url('kasir/transaksi_umum/tambah/') ?>" + id,
            type: 'POST',
            data: {
                sell_type: sell_type,
    ...
    function hapus_cart(id, produk_id) {
        ...
        $('#iya_hapus').click(function() {
            ...
            $.ajax({
                url: "<?php echo site_url('kasir/transaksi_umum/hapus_cart') ?>",
                method: "POST",
                data: {
                    row_id: id
                },
    ...
    $('#dibayar').on('change keyup', function() {
        ...
        if ($(this).val().length >= 4) {
            $.ajax({
                url: "<?php echo site_url('kasir/transaksi_umum/hitung/') ?>" + ($(this).val().replace(/[^\d]/g, '')),
                dataType: "JSON",
                beforeSend: function() {
