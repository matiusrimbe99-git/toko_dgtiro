...
class Data_transaksi extends CI_Controller
{
	...
	public function index()
	{
		...
		$config['base_url'] = base_url("kasir/data_transaksi?per_page={$this->per_page}&query={$this->query}&from={$this->from}&to={$this->to}&kasir={$this->cashier}");
		...
		$this->load->view('kasir/laporan/data-transaksi', $data);
	...
	public function update($param = 0)
	{
		...
		$this->template->view('kasir/laporan/ubah-transaksi', $data);
	}
	...
	public function addedcart($param = 0)
	{
		...
		if ($qty > $product->stok) {
			...
			$output = array(
				'status' => true,
				'ref' => site_url('kasir/transaksi_umum'),
	...
	public function report()
	{
		...
		$this->load->view('templates_kasir/sidebar');
		$this->load->view('templates_kasir/navbar', $data);
		$this->load->view('kasir/laporan/buat-laporan', $data);
		$this->load->view('templates_kasir/footer');
	}
	...
	public function cetaklaporan()
	{
		...
		$this->load->view('kasir/laporan/cetak-laporan', $data);
	}
}
